...
\author{ Yuvraj Chowdary Makkena - AI23MTECH02003$^{*}$% <-this % stops a space
...
\text{when two dice are thrown, There are 36 possible outcomes in total.}
...
\begin{figure}[!ht]
    \center
    \includegraphics[width=0.6\linewidth]{dice.png}
